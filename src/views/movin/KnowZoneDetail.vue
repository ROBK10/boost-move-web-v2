  ...
  <div class="page" v-if="article">
    <div class="container">
      ...
      <header class="top">
        ...
        <div class="topRight">
          <span v-if="!completed" class="badge">{{ currentStep + 1 }} / {{ total }}</span>
          <button
            class="starBtn"
            type="button"
      ...
      <template v-else-if="!completed">
        ...
        <div class="navRow">
          <button class="nextBtn" type="button" @click="next">
            <span v-if="!isLast">Neste</span>
            <span v-else>Fullfør</span>
      ...
      <template v-else>
        <div class="doneCard">
          ...
          <p class="doneSub">Du har lest gjennom artikkelen.</p>
        </div>
